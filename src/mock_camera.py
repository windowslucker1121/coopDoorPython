...
class MockCamera:
    ...
    def __init__(self, device_index=0):
        ...
        self.is_init = True
        logger.info(f"Initialized MockCamera for device {device_index}")
